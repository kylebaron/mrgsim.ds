...
pipeline for summarizing huge simulation outputs. Simulation output objects 
in R claim ownership of their files on disk. Those files are automatically 
removed when the owning object goes out of scope and becomes subject to the 
R garbage collector. While "anonymous" files hold the data in `tempdir()` while 
you are working in R, functions are provided to move your data to more permanent 
