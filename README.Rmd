...
in R claim ownership of files on disk and those files are automatically removed
when the owning object goes out of scope and becomes subject to the R garbage 
collector. While "anonymous" files hold the data in `tempdir()` while you are 
